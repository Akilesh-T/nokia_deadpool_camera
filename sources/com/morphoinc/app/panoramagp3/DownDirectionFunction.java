...
public class DownDirectionFunction extends DirectionFunction {
    public DownDirectionFunction(int inputWidth, int inputHeight, int maxWidth, int maxHeight, int scale, int angle) {
    ...
    public boolean calcPreviewRect(Rect previewRect) {
        if (90 == this.angle) {
            ...
            return true;
        } else if (MediaProviderUtils.ROTATION_270 == this.angle) {

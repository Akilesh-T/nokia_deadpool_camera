            ...
            while (i < length) {
                ...
                if (serialize || deserialize) {
                    ...
                    while (true) {
                        ...
                        field2 = field;
                        previous2 = previous == null ? (BoundField) result.put(name2, createBoundField(context, field, name2, TypeToken.get(fieldType2), serialize2, deserialize)) : previous;
                        i2 = i4 + 1;

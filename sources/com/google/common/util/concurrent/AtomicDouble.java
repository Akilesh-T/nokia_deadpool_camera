...
public class AtomicDouble extends Number implements Serializable {
    ...
    public final double getAndAdd(double delta) {
        while (true) {
            ...
            if (updater.compareAndSet(this, current, Double.doubleToRawLongBits(currentVal + delta))) {
                return currentVal;
            }
        }
    }
    ...
    public final double addAndGet(double delta) {
        while (true) {
            ...
            if (updater.compareAndSet(this, current, Double.doubleToRawLongBits(nextVal))) {
                return nextVal;
            }
        }
    }

...
class AppCompatDelegateImpl extends AppCompatDelegate implements Callback, Factory2 {
        ...
        if (a.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (this.mOverlayActionMode) {
                    subDecor2 = (ViewGroup) inflater.inflate(R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor2 = (ViewGroup) inflater.inflate(R.layout.abc_screen_simple, null);
                }
                subDecor = subDecor2;
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext2, null, R.attr.actionModePopupWindowStyle);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if ((event.getAction() == 0) ? !onKeyDown(keyCode, event) : !onKeyUp(keyCode, event)) {

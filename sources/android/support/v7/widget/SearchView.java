...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (widthDp >= 960 && heightDp >= MotionPictureHelper.FRAME_HEIGHT_9 && config.orientation == 2) {
                return 256;
            }
            if (widthDp >= 600 || (widthDp >= MotionPictureHelper.FRAME_WIDTH_4 && heightDp >= MotionPictureHelper.FRAME_HEIGHT_3)) {
                return 192;
            }
            return 160;
        }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        } else if (widthMode == Ints.MAX_POWER_OF_TWO && this.mMaxWidth > 0) {

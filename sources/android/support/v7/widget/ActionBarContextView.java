    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != Ints.MAX_POWER_OF_TWO) {
            ...
            if (this.mCustomView != null) {
                ...
                this.mCustomView.measure(MeasureSpec.makeMeasureSpec(lp2.width >= 0 ? Math.min(lp2.width, availableWidth) : availableWidth, customWidthMode), MeasureSpec.makeMeasureSpec(lp2.height >= 0 ? Math.min(lp2.height, height) : height, lp2.height != -2 ? Ints.MAX_POWER_OF_TWO : Integer.MIN_VALUE));
            }
            if (this.mContentHeight <= 0) {
                widthMode = 0;

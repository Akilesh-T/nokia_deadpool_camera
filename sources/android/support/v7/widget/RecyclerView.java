...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        /* JADX WARNING: Missing block: B:7:0x001d, code skipped:
            if (r8 != com.google.common.primitives.Ints.MAX_POWER_OF_TWO) goto L_0x0043;
     */
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.dispatchNestedScroll(hresult, adapterSize, overscrollX2, overscrollY2, null, 1)) {
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (canRunFocusFailure && (direction == 2 || direction == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                int absDir = direction == 2 ? Const.CODE_C1_CW2 : 33;
    ...
    L_0x0003:
        if (r9 != r7) goto L_0x0007;
    L_0x0005:
        goto L_0x0125;
    L_0x0007:
        r1 = r7.findContainingItemView(r9);
    ...
    L_0x0011:
        return r1;
    L_0x0012:
        r2 = r7.findContainingItemView(r8);
    ...
    L_0x0019:
        ...
        r2.set(r0, r0, r3, r4);
        r2 = r7.mTempRect;
        r7.offsetDescendantRectToMyCoords(r8, r2);
        r2 = r7.mTempRect2;
        r7.offsetDescendantRectToMyCoords(r9, r2);
        r2 = r7.mLayout;
    ...
    L_0x00db:
        ...
        r1.<init>();
        r5 = "Invalid direction: ";
        r1.append(r5);
        r1.append(r10);
        r5 = r7.exceptionLabel();
        r1.append(r5);
        r1 = r1.toString();
        r0.<init>(r1);
        throw r0;

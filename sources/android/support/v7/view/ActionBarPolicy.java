...
public class ActionBarPolicy {
    ...
    public int getMaxActionButtons() {
        ...
        if (configuration.smallestScreenWidthDp > 600 || widthDp > 600 || ((widthDp > 960 && heightDp > MotionPictureHelper.FRAME_HEIGHT_9) || (widthDp > MotionPictureHelper.FRAME_HEIGHT_9 && heightDp > 960))) {
            return 5;
        }
        if (widthDp >= 500 || ((widthDp > MotionPictureHelper.FRAME_WIDTH_4 && heightDp > MotionPictureHelper.FRAME_HEIGHT_3) || (widthDp > MotionPictureHelper.FRAME_HEIGHT_3 && heightDp > MotionPictureHelper.FRAME_WIDTH_4))) {
            return 4;
        }
        if (widthDp >= 360) {
            return 3;

    ...
    private void replaceAllInternal(@NonNull T[] newData) {
        ...
        while (true) {
            ...
            if (this.mNewDataStart >= newSize && this.mOldDataStart >= this.mOldDataSize) {
                ...
                insertIndex = this.mNewDataStart;
                ...
                insertIndex = this.mOldDataSize - this.mOldDataStart;
                this.mSize -= insertIndex;
                this.mCallback.onRemoved(this.mNewDataStart, insertIndex);
                break;
            } else {

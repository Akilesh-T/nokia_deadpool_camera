...
public class ViewDragHelper {
     ...
     */
    public boolean canScroll(@android.support.annotation.NonNull android.view.View r17, boolean r18, int r19, int r20, int r21, int r22) {
        /*
        r16 = this;
        r0 = r17;
    ...
    public void processTouchEvent(@android.support.annotation.NonNull android.view.MotionEvent r13) {
        /*
        r12 = this;
    ...
    L_0x002f:
        r3 = -1;
        r5 = r13.getPointerCount();
    L_0x0035:
        if (r2 >= r5) goto L_0x0060;
    L_0x0037:
        r6 = r13.getPointerId(r2);
    ...
    L_0x00ba:
        ...
        r2 = r12.isValidPointerForActionMove(r2);
        if (r2 != 0) goto L_0x00c4;
    L_0x00c2:
        goto L_0x0176;
    L_0x00c4:
        r2 = r12.mActivePointerId;
        r2 = r13.findPointerIndex(r2);
        r3 = r13.getX(r2);
        r4 = r13.getY(r2);
        r5 = r12.mLastMotionX;
        ...
        goto L_0x0176;
    L_0x00fa:
        r4 = r13.getPointerCount();
    L_0x00ff:
        if (r2 >= r4) goto L_0x013e;
    L_0x0101:
        r5 = r13.getPointerId(r2);
        r6 = r12.isValidPointerForActionMove(r5);

...
public class LruCache<K, V> {
    ...
    L_0x0000:
        monitor-enter(r5);
        r0 = r5.size;	 Catch:{ all -> 0x0071 }
        if (r0 < 0) goto L_0x0052;
    L_0x0005:
        r0 = r5.map;	 Catch:{ all -> 0x0071 }
    ...
    L_0x001e:
        ...
        r3 = r5.map;	 Catch:{ all -> 0x0071 }
        r3.remove(r1);	 Catch:{ all -> 0x0071 }
        r3 = r5.size;	 Catch:{ all -> 0x0071 }
        r4 = r5.safeSizeOf(r1, r2);	 Catch:{ all -> 0x0071 }
        r3 = r3 - r4;
        r5.size = r3;	 Catch:{ all -> 0x0071 }
        r3 = r5.evictionCount;	 Catch:{ all -> 0x0071 }
        r4 = 1;
        r3 = r3 + r4;
    ...
    L_0x0050:
        ...
        return;
    L_0x0052:
        r0 = new java.lang.IllegalStateException;	 Catch:{ all -> 0x0071 }
        r1 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0071 }
        r1.<init>();	 Catch:{ all -> 0x0071 }
        r2 = r5.getClass();	 Catch:{ all -> 0x0071 }
        r2 = r2.getName();	 Catch:{ all -> 0x0071 }

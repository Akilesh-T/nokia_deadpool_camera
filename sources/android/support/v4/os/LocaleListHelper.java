...
final class LocaleListHelper {
    ...
    static LocaleListHelper forLanguageTags(@Nullable String list) {
        ...
        String[] tags = list.split(Size.DELIMITER, -1);
    ...
    private int computeFirstMatchIndex(Collection<String> supportedLocales, boolean assumeEnglishIsSupported) {
        ...
        if (assumeEnglishIsSupported) {
            ...
            if (idx < ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
                bestIndex = idx;
            }
        }
        ...
        if (bestIndex == ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
            return 0;
        }
        return bestIndex;
    }
    ...
    @RestrictTo({Scope.LIBRARY_GROUP})
    static void setDefault(@android.support.annotation.Size(min = 1) @NonNull LocaleListHelper locales) {
        setDefault(locales, 0);
    }

    @RestrictTo({Scope.LIBRARY_GROUP})
    static void setDefault(@android.support.annotation.Size(min = 1) @NonNull LocaleListHelper locales, int localeIndex) {
        if (locales == null) {

...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        public Intent getIntent() {
            ...
            z = this.mIntent.getAction().equals("android.intent.action.SEND_MULTIPLE");
            if (!needsSendMultiple && z) {
    ...
    public static void configureMenuItem(MenuItem item, IntentBuilder shareIntent) {
        ...
        stringBuilder.append(shareIntent.getActivity().getClass().getName());

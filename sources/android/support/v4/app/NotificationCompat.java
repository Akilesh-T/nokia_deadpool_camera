...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public Action build() {
                ...
                return new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, remoteInputArr, dataOnlyInputsArr, this.mAllowGeneratedReplies, this.mSemanticAction, this.mShowsUserInterface);
            }
        }
    ...
    public static abstract class Style {
        ...
        L_0x0037:
            r6 = android.support.compat.R.id.notification_background;
            r9 = "setBackgroundResource";
            r10 = android.support.compat.R.drawable.notification_bg_low;
            r2.setInt(r6, r9, r10);
            r6 = android.support.compat.R.id.icon;
            r9 = "setBackgroundResource";
            r10 = android.support.compat.R.drawable.notification_template_icon_low_bg;
            r2.setInt(r6, r9, r10);
            goto L_0x005c;
        L_0x004a:
            r6 = android.support.compat.R.id.notification_background;
            r9 = "setBackgroundResource";
            r10 = android.support.compat.R.drawable.notification_bg;
            r2.setInt(r6, r9, r10);
            r6 = android.support.compat.R.id.icon;
            r9 = "setBackgroundResource";
            r10 = android.support.compat.R.drawable.notification_template_icon_bg;
            r2.setInt(r6, r9, r10);
        L_0x005c:
            r6 = r0.mBuilder;
            r6 = r6.mLargeIcon;
        ...
        L_0x0086:
            r6 = android.support.compat.R.dimen.notification_right_icon_size;
            r6 = r1.getDimensionPixelSize(r6);
            r9 = android.support.compat.R.dimen.notification_small_icon_background_padding;
            r9 = r1.getDimensionPixelSize(r9);
            r9 = r9 * 2;
            r9 = r6 - r9;
        ...
        L_0x009a:
            ...
            r11 = r0.mBuilder;
            r11 = r11.getColor();
            r7 = r0.createIconWithBackground(r7, r6, r9, r11);
            r11 = android.support.compat.R.id.right_icon;
        ...
        L_0x00b0:
            ...
            r14 = r14.icon;
            r7 = r0.createColoredBitmap(r14, r7);
            r2.setImageViewBitmap(r11, r7);
        L_0x00bf:
            r7 = android.support.compat.R.id.right_icon;
        ...
        L_0x00d8:
            r6 = android.support.compat.R.dimen.notification_large_icon_width;
            r6 = r1.getDimensionPixelSize(r6);
            r7 = android.support.compat.R.dimen.notification_big_circle_margin;
            r7 = r1.getDimensionPixelSize(r7);
            r6 = r6 - r7;
            r7 = android.support.compat.R.dimen.notification_small_icon_size_as_large;
            r7 = r1.getDimensionPixelSize(r7);
            r9 = r0.mBuilder;
            r9 = r9.mNotification;
            r9 = r9.icon;
            r11 = r0.mBuilder;
            r11 = r11.getColor();
            r9 = r0.createIconWithBackground(r9, r6, r7, r11);
            r11 = android.support.compat.R.id.icon;
        ...
        L_0x0101:
            ...
            r9 = r9.mNotification;
            r9 = r9.icon;
            r7 = r0.createColoredBitmap(r9, r7);
        ...
        L_0x0116:
            r6 = android.support.compat.R.id.title;
            r7 = r0.mBuilder;
            r7 = r7.mContentTitle;
        ...
        L_0x0125:
            r6 = android.support.compat.R.id.text;
            r7 = r0.mBuilder;
            r7 = r7.mContentText;
            r2.setTextViewText(r6, r7);
            r3 = 1;
        ...
        L_0x0142:
            r7 = android.support.compat.R.id.info;
            r8 = r0.mBuilder;
            r8 = r8.mContentInfo;
        ...
        L_0x015b:
            r7 = android.support.compat.R.integer.status_bar_notification_info_maxnum;
            r7 = r1.getInteger(r7);
            r8 = r0.mBuilder;
            r8 = r8.mNumber;
            if (r8 <= r7) goto L_0x0173;
        L_0x0167:
            r8 = android.support.compat.R.id.info;
            r9 = android.support.compat.R.string.status_bar_notification_info_overflow;
            r9 = r1.getString(r9);
            r2.setTextViewText(r8, r9);
            goto L_0x0185;
        L_0x0173:
            r8 = java.text.NumberFormat.getIntegerInstance();
            r9 = android.support.compat.R.id.info;
            r11 = r0.mBuilder;
            r11 = r11.mNumber;
            r10 = (long) r11;
            r10 = r8.format(r10);
        ...
        L_0x01b0:
            r6 = android.support.compat.R.id.text2;
            r7 = r0.mBuilder;
            r7 = r7.mContentText;
            r2.setTextViewText(r6, r7);
            r6 = android.support.compat.R.id.text2;
        ...
        L_0x01d8:
            r5 = android.support.compat.R.dimen.notification_subtext_size;
            r5 = r1.getDimensionPixelSize(r5);
            r5 = (float) r5;
            r6 = android.support.compat.R.id.text;
            r2.setTextViewTextSize(r6, r12, r5);
        L_0x01e4:
            r6 = android.support.compat.R.id.line1;
            r7 = 0;
            r8 = 0;
            r9 = 0;
            r15 = 0;
        ...
        L_0x01f4:
            r5 = r0.mBuilder;
            r5 = r5.getWhenIfShowing();
            r7 = 0;
            r5 = (r5 > r7 ? 1 : (r5 == r7 ? 0 : -1));
            if (r5 == 0) goto L_0x0245;
        L_0x0200:
            r5 = r0.mBuilder;
            r5 = r5.mUseChronometer;
        ...
        L_0x020c:
            r5 = android.support.compat.R.id.chronometer;
            r2.setViewVisibility(r5, r12);
            r5 = android.support.compat.R.id.chronometer;
            r6 = "setBase";
            r7 = r0.mBuilder;
            r7 = r7.getWhenIfShowing();
            ...
            goto L_0x0244;
        L_0x0232:
            r5 = android.support.compat.R.id.time;
            r2.setViewVisibility(r5, r12);
            r5 = android.support.compat.R.id.time;
            r6 = "setTime";
            r7 = r0.mBuilder;
        ...
        L_0x0244:
            r3 = 1;
        L_0x0245:
            r5 = android.support.compat.R.id.right_side;
        ...
        L_0x024d:
            ...
            r5 = android.support.compat.R.id.line3;
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle b) {
            ...
            return new UnreadConversation(messages, unreadConversation, onReply, onRead, participants, bundle.getLong("timestamp"));
        }
            ...
            if (VERSION.SDK_INT >= 24) {
                ...
                for (Message compatMessage : this.mMessages) {
                    ...
                    if (VERSION.SDK_INT >= 28) {
                        ...
                        frameworkMessage = new android.app.Notification.MessagingStyle.Message(compatMessage.getText(), compatMessage.getTimestamp(), compatMessagePerson == null ? null : compatMessagePerson.toAndroidPerson());
                    } else {
    ...
    static Action getActionCompatFromAction(android.app.Notification.Action action) {
        ...
        z = action.getExtras().getBoolean("android.support.action.showsUserInterface", true);
        if (VERSION.SDK_INT >= 28) {
            semanticAction = action.getSemanticAction();
        } else {
            semanticAction = action.getExtras().getInt("android.support.action.semanticAction", 0);
        }
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputs, null, allowGeneratedReplies, semanticAction, z);
    }

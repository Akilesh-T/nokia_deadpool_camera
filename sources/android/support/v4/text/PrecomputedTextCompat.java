...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(@NonNull CharSequence text, @NonNull Params params) {
        ...
        if (VERSION.SDK_INT >= 23) {
            ...
            StaticLayout staticLayout = new StaticLayout(text, params.getTextPaint(), ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }

                ...
                while (i2 < count) {
                    ...
                    if (params instanceof ScaledLayoutParams) {
                        ...
                        if (scaleStartRow < 0.0f || scaleStartRow > 1.0f) {
                            ...
                            widthSpecSize2 = MeasureSpec.makeMeasureSpec((int) (((float) width) * (scaleEndCol - scaleStartCol)), Ints.MAX_POWER_OF_TWO);
                            ...
                            child.measure(widthSpecSize2, MeasureSpec.makeMeasureSpec((int) (((float) height) * (scaleEndRow - scaleStartRow)), Ints.MAX_POWER_OF_TWO));
                            i2++;

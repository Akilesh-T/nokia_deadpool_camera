...
class Cea608CCParser {
    ...
    private static class CCData {
        private static final String[] sCtrlCodeMap = new String[]{"RCL", "BS", "AOF", "AON", "DER", "RU2", "RU3", "RU4", "FON", "RDC", "TR", "RTD", "EDM", "CR", "ENM", "EOC"};
        private static final String[] sProtugueseCharMap = new String[]{"Ã", "ã", "Í", "Ì", "ì", "Ò", "ò", "Õ", "õ", "{", "}", "\\", "^", "_", "|", "~", "Ä", "ä", "Ö", "ö", "ß", "¥", "¤", "│", "Å", "å", "Ø", "ø", "┌", "┐", "└", "┘"};
        private static final String[] sSpanishCharMap = new String[]{"Á", "É", "Ó", "Ú", "Ü", "ü", "‘", "¡", "*", "'", "—", "©", "℠", "•", "“", "”", "À", "Â", "Ç", "È", "Ê", "Ë", "ë", "Î", "Ï", "ï", "Ô", "Ù", "ù", "Û", "«", "»"};
        private static final String[] sSpecialCharMap = new String[]{"®", "°", "½", "¿", "™", "¢", "£", "♪", "à", " ", "è", "â", "ê", "î", "ô", "û"};
        ...
        public int getCtrlCode() {
            if ((this.mData1 == Ascii.DC4 || this.mData1 == Ascii.FS) && this.mData2 >= (byte) 32 && this.mData2 <= (byte) 47) {
                return this.mData2;
            }
            return -1;
        }
        ...
        public StyleCode getMidRow() {
            if ((this.mData1 == (byte) 17 || this.mData1 == Ascii.EM) && this.mData2 >= (byte) 32 && this.mData2 <= (byte) 47) {
        ...
        public int getTabOffset() {
            if ((this.mData1 == Ascii.ETB || this.mData1 == Ascii.US) && this.mData2 >= (byte) 33 && this.mData2 <= (byte) 35) {
        ...
        private String ctrlCodeToString(int ctrlCode) {
            return sCtrlCodeMap[ctrlCode - 32];
        }

        private boolean isBasicChar() {
            return this.mData1 >= (byte) 32 && this.mData1 <= Ascii.DEL;
        }

        private boolean isSpecialChar() {
            return (this.mData1 == (byte) 17 || this.mData1 == Ascii.EM) && this.mData2 >= (byte) 48 && this.mData2 <= (byte) 63;
        }

        private boolean isExtendedChar() {
            return (this.mData1 == Ascii.DC2 || this.mData1 == Ascii.SUB || this.mData1 == (byte) 19 || this.mData1 == Ascii.ESC) && this.mData2 >= (byte) 32 && this.mData2 <= (byte) 63;
        }
        ...
        private String getBasicChars() {
            if (this.mData1 < (byte) 32 || this.mData1 > Ascii.DEL) {
                return null;
            }
            StringBuilder builder = new StringBuilder(2);
            builder.append(getBasicChar(this.mData1));
            if (this.mData2 >= (byte) 32 && this.mData2 <= Ascii.DEL) {
        ...
        private String getSpecialChar() {
            if ((this.mData1 == (byte) 17 || this.mData1 == Ascii.EM) && this.mData2 >= (byte) 48 && this.mData2 <= (byte) 63) {
        ...
        private String getExtendedChar() {
            if ((this.mData1 == Ascii.DC2 || this.mData1 == Ascii.SUB) && this.mData2 >= (byte) 32 && this.mData2 <= (byte) 63) {
                return sSpanishCharMap[this.mData2 - 32];
            }
            if ((this.mData1 == (byte) 19 || this.mData1 == Ascii.ESC) && this.mData2 >= (byte) 32 && this.mData2 <= (byte) 63) {
        ...
        public String toString() {
            if (this.mData1 >= Ascii.DLE || this.mData2 >= Ascii.DLE) {
                if (getCtrlCode() != -1) {
    ...
    private static class StyleCode {
        ...
        static final String[] sColorMap = new String[]{"WHITE", "GREEN", "BLUE", "CYAN", "RED", "YELLOW", "MAGENTA", "INVALID"};
        final int mColor;
        final int mStyle;
        ...
        public String toString() {
            ...
            str.append("{");
            str.append(sColorMap[this.mColor]);
            if ((this.mStyle & 1) != 0) {
                str.append(", ITALICS");
            }
            if ((this.mStyle & 2) != 0) {

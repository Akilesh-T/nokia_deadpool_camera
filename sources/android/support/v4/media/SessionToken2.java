...
public final class SessionToken2 {
    ...
    @RestrictTo({Scope.LIBRARY_GROUP})
    public static void createSessionToken2(@NonNull final Context context, @NonNull final Token token, @NonNull Executor executor, @NonNull final OnSessionToken2CreatedListener listener) {
        if (context == null) {
            ...
            executor.execute(new Runnable() {
                public void run() {
                    try {
                        ...
                        controller.registerCallback(new Callback() {

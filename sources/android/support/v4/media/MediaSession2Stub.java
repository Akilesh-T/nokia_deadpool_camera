...
class MediaSession2Stub extends Stub {
     ...
     */
                public void run() {
                    /*
                    r5 = this;
                    r0 = android.support.v4.media.MediaSession2Stub.this;
                    r0 = r0.mLock;
                    monitor-enter(r0);
                    r1 = android.support.v4.media.MediaSession2Stub.this;	 Catch:{ all -> 0x00c0 }
                    r1 = r1.mControllers;	 Catch:{ all -> 0x00c0 }
                    r2 = r4;	 Catch:{ all -> 0x00c0 }
                    r1 = r1.containsValue(r2);	 Catch:{ all -> 0x00c0 }
                ...
                L_0x001c:
                    ...
                    r1 = r4;
                    r2 = r5;
                    r0 = r0.isAllowedCommand(r1, r2);
                    if (r0 != 0) goto L_0x0029;
                L_0x0028:
                    return;
                L_0x0029:
                    r0 = android.support.v4.media.MediaSession2Stub.sCommandsForOnCommandRequest;
                    r1 = r5;
                    r1 = r1.getCommandCode();
                    r0 = r0.get(r1);
                    r0 = (android.support.v4.media.SessionCommand2) r0;
                    goto L_0x0053;
                L_0x003a:
                    r0 = android.support.v4.media.MediaSession2Stub.this;
                    r1 = r4;
                ...
                L_0x0055:
                    r1 = android.support.v4.media.MediaSession2Stub.this;
                    r1 = r1.mSession;
                    r1 = r1.getCallback();
                    r2 = android.support.v4.media.MediaSession2Stub.this;
                    r2 = r2.mSession;
                    r2 = r2.getInstance();
                    r3 = r4;
                    r1 = r1.onCommandRequest(r2, r3, r0);
                    if (r1 != 0) goto L_0x009a;
                L_0x006d:
                    r2 = "MediaSession2Stub";
                    r3 = new java.lang.StringBuilder;
                    r3.<init>();
                    r4 = "Command (";
                    r3.append(r4);
                    ...
                    r4 = " was rejected by ";
                    r3.append(r4);
                    r4 = android.support.v4.media.MediaSession2Stub.this;
                    r4 = r4.mSession;
                    r3.append(r4);
                    r3 = r3.toString();
                    ...
                    return;
                L_0x009a:
                    r1 = r7;	 Catch:{ RemoteException -> 0x00a2 }
                    r2 = r4;	 Catch:{ RemoteException -> 0x00a2 }
                    r1.run(r2);	 Catch:{ RemoteException -> 0x00a2 }
                    goto L_0x00bf;
                L_0x00a2:
                    r1 = move-exception;
                    r2 = "MediaSession2Stub";
                ...
                L_0x00c0:
                    ...
                    throw r1;
                    */
                    throw new UnsupportedOperationException("Method not decompiled: android.support.v4.media.MediaSession2Stub$AnonymousClass1.run():void");
                }
            });
        }
    }
        ...
        this.mSession.getCallbackExecutor().execute(new Runnable() {
            public void run() {
                if (!MediaSession2Stub.this.mSession.isClosed()) {
                    ...
                    boolean z = allowedCommands != null || controllerInfo.isTrusted();
                    String str;

...
public final class MediaControllerCompat {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public final void registerCallback(android.support.v4.media.session.MediaControllerCompat.Callback r5, android.os.Handler r6) {
            /*
            r4 = this;
            r0 = r4.mControllerObj;
            r1 = r5.mCallbackObj;
            android.support.v4.media.session.MediaControllerCompatApi21.registerCallback(r0, r1, r6);
            r0 = r4.mSessionToken;
            r0 = r0.getExtraBinder();
            if (r0 == 0) goto L_0x0030;
        L_0x0011:
            r0 = new android.support.v4.media.session.MediaControllerCompat$MediaControllerImplApi21$ExtraCallback;
            r0.<init>(r5);
            r1 = r4.mCallbackMap;
            r1.put(r5, r0);
            r5.mIControllerCallback = r0;
            r1 = r4.mSessionToken;	 Catch:{ RemoteException -> 0x0027 }
            r1 = r1.getExtraBinder();	 Catch:{ RemoteException -> 0x0027 }
            r1.registerCallbackListener(r0);	 Catch:{ RemoteException -> 0x0027 }
            goto L_0x002f;
        L_0x0027:
            r1 = move-exception;
            r2 = "MediaControllerCompat";
            r3 = "Dead object in registerCallback.";
            android.util.Log.e(r2, r3, r1);
        L_0x002f:
            goto L_0x003c;
        L_0x0030:
            r0 = r4.mPendingCallbacks;
            monitor-enter(r0);
            r1 = 0;
            r5.mIControllerCallback = r1;	 Catch:{ all -> 0x003d }
            r1 = r4.mPendingCallbacks;	 Catch:{ all -> 0x003d }
        ...
        L_0x0011:
            r0 = r3.mCallbackMap;	 Catch:{ RemoteException -> 0x0028 }
            r0 = r0.remove(r4);	 Catch:{ RemoteException -> 0x0028 }
            r0 = (android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback) r0;	 Catch:{ RemoteException -> 0x0028 }
            if (r0 == 0) goto L_0x0030;
        L_0x001b:
            r1 = 0;
            r4.mIControllerCallback = r1;	 Catch:{ RemoteException -> 0x0028 }
            r1 = r3.mSessionToken;	 Catch:{ RemoteException -> 0x0028 }
            r1 = r1.getExtraBinder();	 Catch:{ RemoteException -> 0x0028 }
            r1.unregisterCallbackListener(r0);	 Catch:{ RemoteException -> 0x0028 }
            goto L_0x0030;
        L_0x0028:
            r0 = move-exception;
            r1 = "MediaControllerCompat";
            r2 = "Dead object in unregisterCallback.";
            android.util.Log.e(r1, r2, r0);
        L_0x0030:
            goto L_0x003a;
        L_0x0031:
            r0 = r3.mPendingCallbacks;
            monitor-enter(r0);
            r1 = r3.mPendingCallbacks;	 Catch:{ all -> 0x003b }

...
public class MediaSessionCompat {
                ...
                try {
                    ...
                    if (command.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (impl != null) {
                            ...
                            String str = MediaSessionCompat.KEY_EXTRA_BINDER;
                            if (extraBinder == null) {
                                iBinder = null;
                            } else {
                            ...
                            if (token2 != null) {
                                item2 = token2.toBundle();
                            }
                            result.putBundle(str2, item2);
                            cb.send(0, result);
                        }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public static QueueItem fromQueueItem(Object queueItem) {
            return (queueItem == null || VERSION.SDK_INT < 21) ? null : new QueueItem(queueItem, MediaDescriptionCompat.fromMediaDescription(QueueItem.getDescription(queueItem)), QueueItem.getQueueId(queueItem));
        }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle tokenBundle) {
            ...
            IMediaSession extraSession = Stub.asInterface(BundleCompat.getBinder(tokenBundle, MediaSessionCompat.KEY_EXTRA_BINDER));
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                int controlType2;
                                if (volumeType == 2) {
                                    controlType2 = vp.getVolumeControl();
                                    try {
                                        try {
            ...
            public PlaybackStateCompat getPlaybackState() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    try {
                        ...
                        try {
                            MediaMetadataCompat state2 = MediaSessionImplBase.this.mMetadata;
                            return MediaSessionCompat.getStateWithUpdatedPosition(state, state2);
                        } catch (Throwable th2) {
                            th = th2;
        ...
        public void postToHandler(int what, int arg1, int arg2, Object obj, Bundle extras) {
            synchronized (this.mLock) {
                if (this.mHandler != null) {
                    ...
                    data.putString(MediaSessionCompat.DATA_CALLING_PACKAGE, RemoteUserInfo.LEGACY_CONTROLLER);

        ...
        public String nodesToString(PathDataNode[] nodes) {
            ...
            while (i < nodes.length) {
                ...
                for (float append : params) {
                    ...
                    stringBuilder2.append(Size.DELIMITER);
            ...
            if (matrixScale != 0.0f) {
                ...
                if (vPath.isClipPath()) {
                    ...
                    if (fullPath.mStrokeColor != 0) {
                        ...
                        fillPaint.setColor(VectorDrawableCompat.applyAlpha(fullPath.mStrokeColor, fullPath.mStrokeAlpha));
                        fillPaint.setColorFilter(colorFilter);
